...
function TestLogging.testViolationPolicyMatchesSourceCallSites()
    local files = {
        ...
        "src/core/module_bootstrap/ui/ui_host.lua",
        "src/core/cache/00_init.lua",
        "src/core/cache/adapters/author_cache.lua",
        "src/core/cache/current_run_cache.lua",
        "src/core/cache/persistent_cache.lua",
        "src/core/cache/shared_cache.lua",
        "src/core/hooks/00_init.lua",
        "src/core/hooks/adapters/author_declarations.lua",
        "src/core/hooks/adapters/host_install.lua",
        ...
        "src/core/module_bootstrap/host_activation.lua",
        "src/core/module_bootstrap/host_lifecycle.lua",
        "src/core/integrations/00_init.lua",
        "src/core/integrations/adapters/author_integrations.lua",
        "src/core/integrations/adapters/host_install.lua",
        "src/core/integrations/events/events.lua",
        "src/core/integrations/polling/polling.lua",
        "src/core/integrations/polling/read_scope.lua",
        ...
        "src/core/overlays/adapters/author_declarations.lua",
        "src/core/overlays/adapters/framework_overlays.lua",
        "src/core/overlays/adapters/host_install.lua",
        ...
        "src/core/mutations/adapters/author_patch.lua",
        "src/core/mutations/adapters/host_lifecycle.lua",
