...
local function createLibHarness(opts)
    ...
    local harness = {
        ...
        cacheBundle = imports["core/cache/cache.lua"],
        cache = imports["core/cache/cache.lua"].service,
        ...
        widgetsBundle = imports["core/widgets/init.lua"],
        widgets = imports["core/widgets/init.lua"].widgets,
        nav = imports["core/widgets/init.lua"].nav,
