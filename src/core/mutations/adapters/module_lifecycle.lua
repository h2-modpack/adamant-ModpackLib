...
function moduleAdapter.applyForModule(module)
    local record = requireModuleRecord(module, "mutation.applyForModule")
...
function moduleAdapter.syncForModule(module)
    local record = requireModuleRecord(module, "mutation.syncForModule")
...
function moduleAdapter.revertForModule(module)
    requireModuleRecord(module, "mutation.revertForModule")
